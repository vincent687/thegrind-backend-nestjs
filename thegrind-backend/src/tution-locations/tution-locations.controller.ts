...
export class TutionLocationsController {
  constructor(private readonly tutionLocationsService: TutionLocationsService) {}
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateTutionLocationDto: UpdateTutionLocationDto) {
